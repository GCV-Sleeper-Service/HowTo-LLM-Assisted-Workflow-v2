...
| --- | --- | --- | --- |
| 1 | **Plausible narrative** - an elegant explanation is accepted without the one-line check that would falsify it | The explanation is more interesting than the observation and this lets you carry away | Confirm *what* before hypothesizing *why*; one diagnostic command first (Occam's Razon again) ([Section 2.6, Chapter 2](02-operating-model.md#26-truth-seeking-as-a-named-discipline)) |
...
| 11 | **Contradictory planning documents** - roadmap, phase plan, and decision log disagree; the newest conversation silently wins | Two documents give different orders or targets for the same phase | Source-of-truth ranking; a plan that changes a logged decision writes the superseding line first (Chapters [2](02-operating-model.md)-[3](03-state-and-continuity.md)) |
| 12 | **Infeasible as written** - a plan step assumes a platform capability that does not exist in the version you use | The step names a library feature without a citation to current documentation | Every hardware/platform claim in a plan cites a current source; research steps (no version bump) precede implementation ([Chapter 6](06-review-verify-close.md)) |
